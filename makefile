...
main.o:
	gcc -I "./include/libfdr" -c ./src/main.c -o ./lib/main.o

program:main.o fields.o dllist.o jrb.o jval.o
	gcc ./lib/libfdr/fields.o ./lib/libfdr/jrb.o ./lib/libfdr/jval.o ./lib/libfdr/dllist.o ./lib/main.o -o ./bin/program	
